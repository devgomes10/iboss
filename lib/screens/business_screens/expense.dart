        ...
        body: Column(
          children: [
            ...
            Expanded(
              child: TabBarView(
                children: [
                  Consumer<FixedExpenseRepository>(builder:
                      (BuildContext context, FixedExpenseRepository fixed,
                          Widget? widget) {
                  ...
                  Consumer<VariableExpenseRepository>(builder:
                      (BuildContext context, VariableExpenseRepository variable,
                          Widget? widget) {
...
//                             children: [
//                               Consumer<FixedExpenseRepository>(
//                                 builder: (BuildContext context, FixedExpenseRepository fixed, Widget? widget) {
//                                   return TextButton(
//                                     onPressed: () async {
//                                       fixed.add(FixedExpense(
//                                         description: descriptionController.text,
//                                         value: double.parse(valueController.text),
//                                         date: date, // Usando a data atual
//                                       ));
//                                       ScaffoldMessenger.of(context).showSnackBar(
//                                         SnackBar(
//                                           content: Text('Criando um gasto fixo'),
//                                         ),
//                                       );
//                                       Navigator.pop(context);
//                                     },
...
//                               ),
//                               Consumer<VariableExpenseRepository>(
//                                 builder: (BuildContext context, VariableExpenseRepository variable, Widget? widget) {
//                                   return TextButton(
//                                     onPressed: () async {
//                                       variable.add(VariableExpense(
//                                         description: descriptionController.text,
...
//                                       ScaffoldMessenger.of(context).showSnackBar(
//                                         SnackBar(
//                                           content: Text('Criando um gasto variável'),
//                                         ),
//                                       );
//                                       Navigator.pop(context);
//                                     },
