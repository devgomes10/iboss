              ...
              child: TabBarView(
                children: [
                  StreamBuilder<List<CompanyGoals>>(
                    stream: Provider.of<CompanyGoalsRepository>(context)
                        .getCompanyGoalsStream(),
                    builder: (BuildContext context, AsyncSnapshot<List<CompanyGoals>> snapshot) {
                                        ...
                                        child: Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              TextButton(
                                                onPressed: () async {
                                                  final companyGoalsRepository = Provider.of<CompanyGoalsRepository>(context, listen: false);
                                                  await companyGoalsRepository.removeGoalsFromFirestore(goal.id);
